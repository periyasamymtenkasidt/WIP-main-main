...
const SiteVisitsCalendar = () => {
  ...
  const completedAptDetails = {
    0: {
      report:
        "Completed initial digital survey and inspection of the luxury villa structure. Core masonry works, structural slabs, and plaster layout verified against architectural elevations.",
      measurements:
        "Living Room: 18' x 14' · Kitchen: 12' x 10' · Foyer: 8' x 6' · Main Villa Ceiling Height: 10' 6\"",
      documents: [
        "Villa_Layout_Survey_V1.pdf",
        "Survey_Living_Room_Photos.zip",
      ],
    },
    1: {
      report:
        "Walkthrough with Electrical Contractor Priya S. and Supervisor Vijay K. Plotted television wall sockets, electrical conduits, plumbing inlet connections, and air conditioner sleeve points in the kitchen and living area.",
      measurements:
        "Kitchen Utility Area: 6' x 4.5' · Electrical Conduit Runs: 145 meters · Bedroom Plugs: 12 points",
      documents: ["Electrical_Ceiling_Layout_Marked_V2.pdf"],
    },
    2: {
      report:
        "Detailed physical selection of laminates, wood veneers, and bath tiles at the design gallery with the client. Confirmed Scandinavian light-oak theme and selected quartz countertops for the kitchen.",
      measurements:
        "Quartz Countertop Area: 36 sq ft · Oak Laminate Boards: 14 sheets · Bathroom Accent Tile: 120 sq ft",
      documents: [
        "Material_Selection_Receipt_Approved.pdf",
        "Material_Board_Scandinavian.jpg",
      ],
    },
  };
  ...
  return (
    <div className="p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 text-left">
      ...
      <div className="bg-slate-50 rounded-[20px] p-5 border border-gray-100 flex flex-col justify-between h-fit">
        <h4 className="text-[13px] font-bold text-darkgray uppercase tracking-wider mb-4">
      ...
      <div className="lg:col-span-2 flex flex-col space-y-4">
                ...
                <div className="flex items-center justify-between p-4 hover:bg-slate-50/20">
                  <div className="flex items-center gap-4">
                    <div className="text-center w-12 h-12 bg-white rounded-xl flex flex-col justify-center items-center border border-bordergray shadow-sm shrink-0">
                      <div className="text-[15px] font-bold text-darkgray leading-none">
                        {apt.date}
                      </div>
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className={`px-2.5 py-1 rounded-md text-[9px] font-bold uppercase tracking-wider border ${apt.statusColor}`}
                    >
                      {apt.status}
                    </div>
                    {isCompleted && (
        ...
        <p className="text-[10.5px] text-gray-400 mt-2 text-center italic font-medium">
          💡 Click on any completed ("Done") visit to expand its report and
          measurements.
        </p>
      </div>
    </div>
