            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 shrink-0">
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] flex items-center justify-between">
                ...
                <div className="flex items-end gap-1.5 h-10 shrink-0">
                  <div className="w-2 rounded-sm bg-[#3B82F6]/30 h-[40%]" />
                  <div className="w-2 rounded-sm bg-[#3B82F6]/60 h-[70%]" />
                  <div className="w-2 rounded-sm bg-[#3B82F6]/80 h-[50%]" />
                  <div className="w-2 rounded-sm bg-[#3B82F6] h-[95%]" />
                </div>
              </div>
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-emerald-600 font-semibold mt-1">
                    {paidCount > 0 ? formatAmount(totalCollected) : "—"}
                  </p>
                </div>
                <div className="flex items-end gap-1.5 h-10 shrink-0">
                  <div className="w-2 rounded-sm bg-[#10B981]/30 h-[30%]" />
                  <div className="w-2 rounded-sm bg-[#10B981]/60 h-[85%]" />
                  <div className="w-2 rounded-sm bg-[#10B981]/80 h-[60%]" />
                  <div className="w-2 rounded-sm bg-[#10B981] h-[90%]" />
                </div>
              </div>
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-orange-500 font-semibold mt-1">
                    {pendingCount > 0 ? formatAmount(remainingCollected) : "—"}
                  </p>
                </div>
                <div className="flex items-end gap-1.5 h-10 shrink-0">
                  <div className="w-2 rounded-sm bg-[#F97316]/30 h-[50%]" />
                  <div className="w-2 rounded-sm bg-[#F97316]/60 h-[35%]" />
                  <div className="w-2 rounded-sm bg-[#F97316]/80 h-[80%]" />
                  <div className="w-2 rounded-sm bg-[#F97316] h-[95%]" />
                </div>
              </div>
            </div>
              ...
              {activeTab === "milestones" && (
                <div className="p-6 sm:p-8 space-y-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mb-6 p-5 rounded-[16px] bg-[#E9E9FF]/20 border border-border">
