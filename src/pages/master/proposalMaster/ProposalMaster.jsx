...
// Quick-add chips are derived at runtime from the Master → Schedule categories
// (see `quickAreas` in the component), so they stay in sync and carry the
                  ...
                  {quickAreas.map((q) => {
                    ...
                    return (
                      <button
                        ...
                        title={
                          q.days ? `${q.name} · ${q.days} working days` : q.name
                        }
